...
yum -y erase gtk2 libX11 hicolor-icon-theme freetype bitstream-vera-fonts wireless-tools avahi *i386 *i586 *i686
yum -y install kernel-devel-`uname -r` yum-priorities
